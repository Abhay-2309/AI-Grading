...
import { GEMINI_RESPONSE_SCHEMA } from '../../../schemas/grading-report.schema.js';
...
export class GeminiGrader implements VisionGrader {
  readonly name = 'gemini' as const;
  private readonly client: GoogleGenerativeAI;

  constructor(apiKey = config.GEMINI_API_KEY, private readonly modelName = config.GEMINI_MODEL) {
